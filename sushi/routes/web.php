...
Route::group(['prefix' => 'admin', 'namespace' => 'back'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'product', 'as' => 'admin.product.'], function () {
            Route::get('/a/{id}', 'ProductController@index')->name('index');
            Route::get('/create', 'ProductController@create')->name('create');
            Route::post('/store', 'ProductController@store')->name('store');
            Route::post('/store2/{id}/{lang}', 'ProductController@store2')->name('store2');
            Route::get('/edit/{id}', 'ProductController@edit')->name('edit');
            Route::post('/update/{id}', 'ProductController@update')->name('update');
            Route::post('/update2/{id}/{lang}','ProductController@update2')->name('update2');
