...
(function () {
    ...
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, e = /</g, f = /"/g, h = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
            k = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, q = function (a, g) {
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, g) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c)) var n = "\x3c" + k + "\x3e", q = "\x3c/" + k + "\x3e",
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
                ...
                table: 1,
                ul: 1
            }, f = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, k = {"#": 1},
    ...
    (function () {
        function a(a, b) {
            ...
            g = c.endContainer;
            var e = c.startOffset, z = c.endOffset, u, l = this.guard, p = this.type,
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, f = CKEDITOR.dom.walker.whitespaces(),
            h = CKEDITOR.dom.walker.bookmark(), k = CKEDITOR.dom.walker.temp(), q = function (a) {
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                if (!this.collapsed) {
                    ...
                    var d = this.clone(), e = this.startContainer, n = this.endContainer, f = this.startOffset,
                        h = this.endOffset, k = 1, u = 1;
            ...
            setEndAt: function (b, c) {
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                    d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, n = d.block, f = null;
    ...
    (function () {
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, p = [], m = this.editor && this.editor.config.protectedSource, r, u = !1,
        ...
        var S = {styles: 1, attributes: 1, classes: 1},
            x = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"},
    ...
    (function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            addCommand: function (a, b) {
                ...
                a = null == a || a;
                this.readOnly != a && (this.readOnly = a, this.keystrokeHandler.blockedKeystrokes[8] =
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (f, h, k) {
                ...
                var C = new CKEDITOR.htmlParser,
                    ...
                    y = [], F = [], w = n, u = "textarea" == n.name, l = "pre" == n.name;
                    ...
                    if (a(m)) y.push(m); else {
                        ...
                        if ("br" == e) F.push(m); else {
                            for (; !(r = (f = w.name) ? CKEDITOR.dtd[f] || (w._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, m.isUnknown || w.isUnknown || r[e]);) if (w.isOptionalClose) C.onTagClose(f); else if (e in b && f in b) f = w.children, (f = f[f.length - 1]) && "li" == f.name || z(f = new CKEDITOR.htmlParser.element("li"), w), !m.returnPoint && (m.returnPoint = w), w = f; else if (e in CKEDITOR.dtd.$listItem &&
                                !v(e, f)) C.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (f in d && !v(e, f)) !m.returnPoint && (m.returnPoint = w), w = w.parent; else if (f in CKEDITOR.dtd.$inline && y.unshift(w), w.parent) z(w, w.parent, 1); else {
                                m.isOrphan = 1;
                                break
                            }
                            q(e);
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    f = Array.prototype.slice.call(arguments, 1), h = this.rules, k = h.length, q, t, g, z;
    ...
    (function () {
        ...
        function n(a, b) {
            var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore =
                    {id: 1}), l = /<\!--\{cke_temp(comment)?\}(\d*?)--\x3e/g,
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, e, c = n(c, b), c = g(c, M), c = t(c), c = g(c, T), c = c.replace(x, "$1cke:$2"),
        ...
        var y = /(?:&nbsp;|\xa0)$/, F = "{cke_protected}", w = CKEDITOR.dtd,
            u = "caption colgroup col thead tfoot tbody".split(" "), l = CKEDITOR.tools.extend({}, w.$blockLimit,
            w.$block), p = {elements: {input: k, textarea: k}},
        ...
        var G = /<(a|area|img|input|source)\b([^>]*)>/gi,
            B = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, J = /^(href|src|name)$/i,
            T = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            M = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, S = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            x = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            H = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, I = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        var g = CKEDITOR.dom.walker.whitespaces(!0), z = CKEDITOR.dom.walker.bookmark(!1, !0),
            A = CKEDITOR.dom.walker.empty(), v = CKEDITOR.dom.walker.bogus(),
                    ...
                    list: {
                        detectMerge: function (a, b) {
                            var d = c(b, a.bookmark),
                                e = d.startPath(), g = d.endPath(), l = e.contains(CKEDITOR.dtd.$list),
                            ...
                            if (a.mergeListBookmark) {
                                var d = a.mergeListBookmark.startNode,
                                    e = a.mergeListBookmark.endNode, g = new CKEDITOR.dom.elementPath(d, c),
                        ...
                        function a(c) {
                            var e = [], g, l = new CKEDITOR.dom.walker(c), m = c.startPath().contains(d),
                                f = c.endPath().contains(d), p = {};
                            l.guard = function (a,
                                                l) {
                                if (a.type == CKEDITOR.NODE_ELEMENT) {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                var g = e.document, l = CKEDITOR.document, f = e.editable(), p = g.getBody(),
                    k = g.getDocumentElement(), n = f.isInline(), x, H;
    ...
    (function () {
        ...
        var D = {
                ...
                audio: 1,
                video: 1
            }, G = /\s*(?:;\s*|$)/, B = /#\((.+?)\)/g, J = CKEDITOR.dom.walker.bookmark(0, 1),
    ...
    (function () {
        function a(a, c, d) {
            var f = a.serializable, h = c[d ? "endContainer" : "startContainer"], k = d ? "endOffset" : "startOffset",
    ...
    (function () {
        ...
        var t = /^javascript:/, u = /^mailto:([^?]+)(?:\?(.+))?$/, v = /subject=([^;?:@&=$,\/]*)/,
            w = /body=([^;?:@&=$,\/]*)/, x = /^#(.*)$/, y = /^((?:http|https|ftp|news):\/\/)?(.*)$/,
    ...
    CKEDITOR.plugins.add("scayt", {
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", init: function (a) {
            ...
            a.plugins.wsc && (b.WSC = {
                label: a.lang.wsc.toolbar, group: "scaytButton", onClick: function () {
                    var d = CKEDITOR.plugins.scayt, b = a.scayt,
        ...
        bindEvents: function (a) {
            ...
            var c = a.dataProcessor,
                d = c && c.htmlFilter, b = a._.elementsPath && a._.elementsPath.filters, c = c && c.dataFilter,
                f = a.addRemoveFormatFilter, e = function (d) {
